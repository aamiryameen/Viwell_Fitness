...
function FavoriteRewards(props: any) {
        ...
        <AuthContainer>
            <View style={{ flex: 0.9 }}>
                <View style={styles.textContainer}>
                    <Text style={styles.stepTextStyle}>step 9/10</Text>
                    <Text style={styles.headingTextStyle}>Pick your favorite rewards</Text>
                </View>
...
export default FavoriteRewards;