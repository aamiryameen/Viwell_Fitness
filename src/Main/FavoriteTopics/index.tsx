...
function FavoriteTopics(props: any) {
        ...
        <AuthContainer>
            <View style={{ flex: 0.9 }}>
                <View style={styles.textContainer}>
                    <Text style={styles.stepTextStyle}>step 8/10</Text>
                    <Text style={styles.headingTextStyle}>Pick your favorite topics</Text>
                </View>
            ...
            <View style={styles.buttonContainer}>
                <SimpleButton without={false} title="Save" onPress={() => {
                    navigation.navigate('FavoriteRewards')
                }} />
            </View>
        </AuthContainer>
    );
