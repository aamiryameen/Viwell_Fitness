...
function AddBodyMeasurement(props: any) {
        ...
        <AuthContainer>
            <View style={{ flex: 0.9 }}>
                <View style={styles.textContainer}>
                    <Text style={styles.stepTextStyle}>step 4/10</Text>
                    <Text style={styles.headingTextStyle}>What are your body measurements?</Text>
                </View>
                ...
                <View style={{ marginHorizontal: "10%", marginTop: "10%" }}>
                    <Text style={styles.addPhotoText}>Don’t worry, your body data is kept private and will never be sent, used or sold to any third party app</Text>
                </View></View>
